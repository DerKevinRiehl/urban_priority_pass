...
from SimulationTools import genMaxPressureController, generateSpawnEntranceProbabilities
...
parameter2 = 21
settings.tl_control = {
   "J25": genMaxPressureController(min_green=parameter1, auct_sus=parameter2),
   "J26": genMaxPressureController(min_green=parameter1, auct_sus=parameter2),
   "J27": genMaxPressureController(min_green=parameter1, auct_sus=parameter2),
   "J28": genMaxPressureController(min_green=parameter1, auct_sus=parameter2),
   "J29": genMaxPressureController(min_green=parameter1, auct_sus=parameter2),
   "J30": genMaxPressureController(min_green=parameter1, auct_sus=parameter2),
   "J31": genMaxPressureController(min_green=parameter1, auct_sus=parameter2),
   "J32": genMaxPressureController(min_green=parameter1, auct_sus=parameter2),
   "J33": genMaxPressureController(min_green=parameter1, auct_sus=parameter2),
}
...
for flow in traffic_flows:
    ...
    # Run Simulation
    simulator = Simulator(settings, label="demo_max_pressure") 
    ...
    # Store Log
    os.rename("logs/log_summary.xml", "logs/log_summary_max_pressure_flow_"+str(flow)+".xml")