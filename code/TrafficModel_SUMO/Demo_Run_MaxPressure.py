...
from SimulationTools import generateSpawnEntranceProbabilities, analyse_experiment, genMaxPressureController
...
results = analyse_experiment(settings, simulator.recorder)
print(results)